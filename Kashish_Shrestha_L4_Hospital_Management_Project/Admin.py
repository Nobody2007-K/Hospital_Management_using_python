...
class Admin:
    ...
    def management_report(self, doctors, patients):
        ...
        print('Total number of doctors:', len(doctors))
        ...
        for patient in patients:
            ...
            if illness not in illness_types:
                illness_types[illness] = 0
            illness_types[illness] += 1
        for illness, count in illness_types.items():
            print(f"  {illness}: {count} patients")

    def group_by_family(self, patients):
        """Group patients by family surname"""
        print("\n-----Patients Grouped by Family-----")
        families = {}
        for patient in patients:
        ...
        for surname in families:
            ...
            for patient in families[surname]:
